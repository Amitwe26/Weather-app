...
export function Favorites() {
    const { favorites, activeCity, isLight } = useSelector(state => state.weatherReducer)
    ...
    if (!favorites?.length && !list.length) return <div className={`${isLight ? 'light' : ('dark', 'bgcDark')} flex justify-center `}><h1>let's save favorites our cities</h1></div>
    return (
